...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'leitner_step_2_desc': 'Review every 2 days.',
      'leitner_step_3_title': 'Box 3',
      'leitner_step_3_desc': 'Review every 4 days.',
      'leitner_step_4_title': 'Box 4',
      'leitner_step_4_desc': 'Review every 8 days.',
      'leitner_step_5_title': 'Box 5',
      'leitner_step_5_desc': 'Review every 16 days.',
    ...
    'fa': {
      ...
      'leitner_step_2_desc': 'مرور هر ۲ روز.',
      'leitner_step_3_title': 'جعبه ۳',
      'leitner_step_3_desc': 'مرور هر ۴ روز.',
      'leitner_step_4_title': 'جعبه ۴',
      'leitner_step_4_desc': 'مرور هر ۸ روز.',
      'leitner_step_5_title': 'جعبه ۵',
      'leitner_step_5_desc': 'مرور هر ۱۶ روز.',
