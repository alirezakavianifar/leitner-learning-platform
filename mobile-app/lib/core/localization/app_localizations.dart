...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'bundle_badge': 'Special Bundle',
      'courses_included': '{count} Courses Included',
      'save_amount': 'Save {percent}%',
      'view_bundle': 'View Bundle',
      'purchase_bundle': 'Purchase Bundle',
      'bundle_unlocked_success': "Bundle '{title}' successfully unlocked!",
      'already_owned_in_bundle': '{owned} of {total} courses owned',
      'available_in_bundle': "Available in {bundle}",
      'courses_in_bundle': 'Courses in this bundle',
      'bundle_price_breakdown': 'Price Breakdown',
      'bundle_discount': 'Bundle Discount',
      'total_cards_in_bundle': 'Total Cards',
      'filter_all': 'All',
      'filter_individual': 'Individual Courses',
      'filter_bundles': 'Bundles & Packages',
      'all_courses_in_bundle_unlocked': 'All courses in this bundle are unlocked',
      ...
      'greeting_sub': 'Glad to see you again!',
      'words_so_far': 'words learned so far',
      'start_learning': 'Start Learning',
      'practice_more': 'Practice More 👈',
      'review_words_title': 'Review Words',
      'review_words_sub': 'Questions from studied words',
      'daily_practice_badge': 'Daily Practice',
      ...
      'payment_successful_desc': 'Your purchase was verified successfully and content is now unlocked.',
      'payment_ref_id': 'Reference ID: {ref}',
      'payment_cancelled': 'Payment was cancelled.',
      'payment_failed': 'Payment verification failed or was declined by the bank.',
      ...
      'cards_shuffled': 'Cards shuffled randomly.',
      'cards_unshuffled': 'Cards restored to original order.',
      'ai_tutor_title': 'AI Tutor Assistant',
      'ai_tutor_desc': 'Smart AI explanations, vocabulary breakdowns, and learning hints for flashcards.',
      'ai_tutor_hint_title': 'AI Card Assistant',
      'ai_tutor_close': 'Close',
      'ai_tutor_loading': 'Analyzing card with AI...',
      'ai_tutor_not_enabled': 'AI Tutor is currently disabled.',
      'ai_tutor_settings_title': 'AI Tutor (Smart Assistant)',
      'ai_tutor_settings_desc': 'Enable AI-powered card hints, vocabulary insights, and study assistance.',
      'question_label': 'Question',
    },
    'fa': {
      'app_title': 'رایت لرن',
      ...
      'review': 'مرور',
      'courses': 'دوره‌ها',
      'course_bundles': 'پکیج‌های آموزشی',
      'bundle_badge': 'بسته ویژه',
      'courses_included': 'شامل {count} دوره',
      'save_amount': '{percent}٪ صرفه‌جویی',
      'view_bundle': 'مشاهده و خرید پکیج',
      'purchase_bundle': 'خرید پکیج',
      'bundle_unlocked_success': "پکیج '{title}' با موفقیت فعال شد!",
      'already_owned_in_bundle': '{owned} از {total} دوره را دارید',
      'available_in_bundle': 'موجود در {bundle}',
      'courses_in_bundle': 'دوره‌های موجود در این پکیج',
      'bundle_price_breakdown': 'جزئیات قیمت و تخفیف',
      'bundle_discount': 'تخفیف ویژه پکیج',
      'total_cards_in_bundle': 'مجموع کل کارت‌ها',
      'filter_all': 'همه',
      'filter_individual': 'دوره‌های تکی',
      'filter_bundles': 'پکیج‌های ویژه',
      'all_courses_in_bundle_unlocked': 'تمام دوره‌های این پکیج فعال هستند',
      ...
      'greeting_hello': 'سلام 👋',
      'greeting_sub': 'خوشحالم که دوباره میبینمت!',
      'words_so_far': 'کلمه تا الان',
      'start_learning': 'شروع یادگیری',
      'practice_more': 'بیشتر تمرین کن 👈',
      'review_words_title': 'مرور کلمات',
      'review_words_sub': 'سوالاتی از کلمات مطالعه شده',
      'daily_practice_badge': 'تمرین روزانه',
      'words_remaining': 'کلمه مانده',
      'vip_membership': 'اشتراک ویژه',
      'lesson_label': 'درس',
      'due_badge': 'مرور',
      ...
      'invalid_mobile_number': 'شماره موبایل وارد شده معتبر نیست. لطفاً یک شماره ۱۱ رقمی معتبر (مانند 09123456789) وارد کنید.',
      'invalid_captcha': 'کد امنیتی (کپچا) اشتباه وارد شده یا منقضی شده است. لطفاً کد جدید را وارد کنید.',
      'sms_send_failed': 'خطا در ارسال کد تأیید. لطفاً شماره موبایل و اتصال اینترنت خود را بررسی کنید.',
      'invalid_otp': 'کد تأیید ۵ رقمی وارد شده اشتباه یا منقضی شده است. لطفاً کد جدید درخواست کنید.',
      'invalid_input': 'شماره موبایل و کد تأیید الزامی هستند.',
      'captcha_invalid': 'کد امنیتی (کپچا) اشتباه وارد شده است. لطفاً تصویر جدید را وارد کنید.',
      'otp_expired': 'کد تایید ۵ رقمی منقضی شده است. لطفاً کد جدید درخواست کنید.',
      'too_many_requests': 'تعداد درخواست‌ها بیش از حد مجاز است. لطفاً چند دقیقه دیگر دوباره تلاش کنید.',
      'checksum_mismatch': 'تایید اصالت فایل دوره با خطا مواجه شد. لطفاً فایل را مجدداً دانلود کنید.',
      // New localization keys
      ...
      'payment_successful_title': 'پرداخت با موفقیت انجام شد',
      'payment_successful_desc': 'پرداخت شما با موفقیت تأیید شد و دسترسی به دوره فعال گردید.',
      'payment_ref_id': 'کد پیگیری: {ref}',
      'payment_cancelled': 'پرداخت توسط کاربر لغو گردید.',
      'payment_failed': 'پرداخت ناموفق بود یا توسط بانک تایید نشد.',
      'view_courses': 'مشاهده دوره‌ها',
      ...
      'shuffle_cards': 'بر زدن کارت‌ها',
      'restore_order': 'بازگردانی ترتیب اصلی',
      'cards_shuffled': 'ترتیب کارت‌ها به صورت تصادفی بر زده شد.',
      'cards_unshuffled': 'ترتیب کارت‌ها به حالت اولیه بازگشت.',
      'ai_tutor_title': 'دستیار هوش مصنوعی',
      'ai_tutor_desc': 'تحلیل هوشمند، توضیحات تکمیلی و راهنمایی یادگیری کارت‌ها با هوش مصنوعی.',
      'ai_tutor_hint_title': 'تحلیل هوشمند کارت با هوش مصنوعی',
      'ai_tutor_close': 'بستن',
      'ai_tutor_loading': 'در حال تحلیل کارت با هوش مصنوعی...',
      'ai_tutor_not_enabled': 'دستیار هوش مصنوعی در حال حاضر غیرفعال است.',
      'ai_tutor_settings_title': 'دستیار هوش مصنوعی (AI Tutor)',
      'ai_tutor_settings_desc': 'فعال‌سازی تحلیل هوشمند، نکات یادگیری و راهنمای هوش مصنوعی در هنگام مطالعه کارت‌ها',
      'question_label': 'صورت سوال',
    },
  };
